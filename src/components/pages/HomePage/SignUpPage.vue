<template>
  <div id="main">
    ...
    <h3
      style="text-align: center; padding-bottom: 1%; color: white"
      v-show="notLogin"
    >
      You need to log in to access the {{ page }} page!
    </h3>
    <h3 style="text-align: center; padding-bottom: 1%">
      The only personal finance buddy you need
    </h3>

    <div class="register">
      <form id="reg-form">
        <div v-show="showing === 'register'">
          <h3 style="text-align: center; padding-bottom: 5%; padding-top: 5%">
            Create your FinBud account
          </h3>
          <div>
        ...
        <div v-show="showing === 'login'">
          <h3 style="text-align: center; padding-bottom: 5%; padding-top: 5%">
            Enter your FinBud account details
          </h3>
          <div>
        ...
        <div class="btns">
          <div
            class="alt"
            v-show="showing === 'register'"
            v-on:click="toggle('login')"
          >
            I have an account
          </div>
          <div
            class="alt"
            v-show="showing === 'login'"
            v-on:click="toggle('register')"
          >
