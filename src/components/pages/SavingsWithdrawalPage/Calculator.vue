<template>
  <div id="calculator">
    <p id="estimated-time">
      <img src="../../../assets/clock.png" />Estimated Time: 1 min
    </p>
    <br />
    <div id="info">
      <div id="inputs">
        ...
        <p class="input-box" style="padding-top: 2%">
          ...
          <input
            id="startingBalance"
            type="number"
            v-model.trim.lazy.number="startingBalance"
          />
        </p>
        <p class="input-box">
          ...
          <input
            id="returnRate"
            type="number"
            v-model.trim.lazy.number="returnRate"
          />
        </p>
        <p class="input-box">
          <label for="duration"
          ...
          <input
            id="duration"
            type="number"
            v-model.trim.lazy.number="duration"
          />
        </p>
        <p class="input-box">
          <label for="periodicWithdrawal"
            >Periodic Withdrawal ($)
            <div class="tooltip">
              (?)
              <span class="tooltiptext">
          ...
          <input
            id="periodicWithdrawal"
            type="number"
            v-model.trim.lazy.number="periodicWithdrawal"
          />
        </p>
      ...
      <hr />
      <div id="owned">
        <p style="padding: 5%; font-family: Lustria">
          How much you will have after {{ this.duration }} years:
        </p>
